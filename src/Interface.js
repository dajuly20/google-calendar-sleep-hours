...
import InsomniaRange from './features/InsomniaC';
      ...
      {events && (
        <Fragment>
          ...
          {rangeType !== RANGE_TYPE.TOTAL &&
            ...
            (rangeType !== RANGE_TYPE.INSOMNIA) && <RangeChanger />}


          {rangeType === RANGE_TYPE.CUSTOM && rangeType === RANGE_TYPE.INSOMNIA && <CustomRange />}
